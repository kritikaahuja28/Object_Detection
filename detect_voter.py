...
classesFile = "custom_cfg/license.names"
...
modelConfiguration = "custom_cfg/license.cfg"
modelWeights = "weights/license_10000.weights"
...
def drawPred(classId, conf, left, top, right, bottom):
    ...
    cv.rectangle(frame, (left, top - round(1.5*labelSize[1])), (left + round(
        1.5*labelSize[0]), top + baseLine), (0, 0, 255), 1)
...
while cv.waitKey(1) < 0:
    ...
    cv.imshow('license detection', frame)
